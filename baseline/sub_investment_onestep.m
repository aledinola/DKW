...
% sub_investment_onestep computes the investment policies of unconstrained 
% firms. This requires the computation of k_star1 and k_star2.
% INPUTS:
% V1:     Value of unconstrained firm V(k,x), dim: (nk,nx)
% k_grid: Capital grid
% pi_x:   Transition matrix for shock x, dim: (nx,nx)
% theta,delta,q,psi: Scalar parameters
% OUTPUTS:
