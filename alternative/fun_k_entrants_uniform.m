function [k_prob] = fun_k_entrants_uniform(k_grid,k_min,k_max,k_distrib)
...
% Update: we changed the distribution of capital for entrants from Pareto
% to uniform (August 2022).
