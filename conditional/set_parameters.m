...
par.max_iter_tr  = 40;   % max no iter for transition
par.tol_tran     = 0.001; % tol for transition
...
par.emp_min = 0;%0.5; % threshold for microbusinesses. Microbusinesses are excluded from exit rate calculation.
par.lmin    = 0.6; % grant conditionality: must maintain employment at lmin level.
                % lmin is in terms of the emplyment level without the shock
