...
% Simulate a panel of firms from steady-state of the model
...
k_sim     = ones(N_sim,T_sim);
b_sim     = ones(N_sim,T_sim);
...
%% todo: precompute b_next_ind and omega (arrays of dim nk,nb,nx)
