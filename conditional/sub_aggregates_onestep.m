function [entry,output_small,liq,L_small,cost_adj,exit_rate,entry_rate] = ...
    ...
    phi_dist,wage,mass,A,par,min_labor)
...
min_labor_rep = permute(repmat(min_labor,1,1,nb),[1,3,2]); % (nk,nb,nx)
l_opt   = max(min_labor_rep,fun.fun_l(x_val,wage,kappa,par));         % (nk,nb,nx)
